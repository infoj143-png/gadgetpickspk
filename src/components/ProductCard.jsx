...
export default function ProductCard({ product }) {
  ...
  return (
    <div
      ...
      className="bg-white rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-xl hover:border-orange-300 hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col justify-between group overflow-hidden relative"
    >
      ...
      <div>
        ...
        <div className="p-4 space-y-2.5">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-extrabold text-orange-500 tracking-widest uppercase bg-orange-50 px-2 py-0.5 rounded">
              {product.category}
            </span>
          ...
          {/* Product Title */}
          <h3 className="font-extrabold text-slate-900 text-sm group-hover:text-orange-500 transition-colors line-clamp-2 min-h-[40px] leading-snug">
            {product.name}
          </h3>
      ...
      <div className="p-4 pt-0">
        <div className="flex gap-2 items-center">
          ...
          <a
            ...
            className="flex-1 inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-orange-500 hover:bg-orange-600 text-white text-xs font-extrabold rounded-xl shadow-md shadow-orange-500/10 transition-colors"
          >
            Buy on Daraz
          ...
          <button
            onClick={handleShare}
            className="p-2.5 bg-slate-50 hover:bg-orange-50 border border-slate-200/60 hover:border-orange-100 rounded-xl text-slate-600 hover:text-orange-500 transition-all flex-shrink-0"
            title="Share Product"
      ...
      {showShareModal && (
        ...
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="bg-white rounded-2xl max-w-sm w-full p-5 border border-slate-100 shadow-2xl relative animate-scaleUp"
          >
            <h4 className="font-extrabold text-slate-800 text-base mb-2">Share recommendations</h4>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-grow bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium px-3 py-2 outline-none text-slate-600"
              />
              <button
                onClick={copyToClipboard}
                className="p-2 bg-orange-500 text-white rounded-xl hover:bg-orange-600 transition-colors flex items-center justify-center min-w-[40px]"
            ...
            <button
              ...
              className="absolute top-3 right-3 text-slate-400 hover:text-slate-600 text-sm font-extrabold"
            >
              &times;
            </button>
          </div>
